...
# Embedded Profiles Last Modified (UTC): 2026-09-13T19:06:06Z
...
;; `uv tool install X` writes the binary under ~/.local/share/uv/tools and
;; links ~/.local/bin/X to it.
(allow file-read*
    (home-literal "/.local/bin/ruff")          ;; ruff entrypoint when installed via `uv tool install ruff`.
)
